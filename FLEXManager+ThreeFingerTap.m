  ...
  return;
    ...
    * Create the gesture once.
        */
        ...
        [UITapGestureRecognizer avx512_action:^(UIGestureRecognizer *gesture) {
     ...
     if (!manager) {
         NSLog(@"[AVX512] Three-finger tap: manager unavailable");
         return;
     }
    ...
    [targetWindow addGestureRecognizer:avx512_threeFingerTapGesture];
    }
    NSLog(
